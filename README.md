# ⚡ Gestor Energético (EnergeticaHub)
...
- **Gestión de Suministros:** Apartado dedicado (`suministros.html`) para el control de contadores, históricos y consumos.
- **Acceso Protegido (`gestenergatica.html`):** Panel privado restringido para la gestión de datos sensibles y administración del sistema.
...
├── gestion/gestenergatica.html   # Panel protegido de datos sensibles (requiere auth)
